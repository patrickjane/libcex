...
public:
    ...
    std::shared_ptr<Response> Trace(const char* path);
    std::shared_ptr<Response> Trace(const char* path, const Headers& headers);
    std::shared_ptr<Response> Patch(const char* path);
    std::shared_ptr<Response> Patch(const char* path, const Headers& headers);
    std::shared_ptr<Response> Connect(const char* path);
    std::shared_ptr<Response> Connect(const char* path, const Headers& headers);
...
inline std::shared_ptr<Response> Client::Trace(const char* path)
{
    return Trace(path, Headers());
}

inline std::shared_ptr<Response> Client::Trace(const char* path, const Headers& headers)
{
    Request req;
    req.method = "TRACE";
    req.path = path;
...
inline std::shared_ptr<Response> Client::Patch(const char* path, const Headers& headers)
{
    Request req;
    req.method = "PATCH";
    req.path = path;
